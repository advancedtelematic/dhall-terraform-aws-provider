...
let AwsOpsworksStaticWebLayerOptional =
...
let AwsOpsworksStaticWebLayerRequired =
  { stack_id : Text }
let AwsOpsworksStaticWebLayer = AwsOpsworksStaticWebLayerOptional //\\ AwsOpsworksStaticWebLayerRequired

in
{ AwsOpsworksStaticWebLayerOptional = AwsOpsworksStaticWebLayerOptional
, AwsOpsworksStaticWebLayerRequired = AwsOpsworksStaticWebLayerRequired
