...
let AwsOpsworksNodejsAppLayerOptional =
...
let AwsOpsworksNodejsAppLayerRequired =
  { stack_id : Text }
let AwsOpsworksNodejsAppLayer = AwsOpsworksNodejsAppLayerOptional //\\ AwsOpsworksNodejsAppLayerRequired

in
{ AwsOpsworksNodejsAppLayerOptional = AwsOpsworksNodejsAppLayerOptional
, AwsOpsworksNodejsAppLayerRequired = AwsOpsworksNodejsAppLayerRequired
