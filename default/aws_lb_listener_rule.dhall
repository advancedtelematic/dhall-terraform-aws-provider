...
let action =
  ...
  , authenticate_cognito = None (../dhall/aws_lb_listener_rule.dhall).AuthenticateCognito
  , authenticate_oidc = None (../dhall/aws_lb_listener_rule.dhall).AuthenticateOidc
  , fixed_response = None (../dhall/aws_lb_listener_rule.dhall).FixedResponse
  , redirect = None (../dhall/aws_lb_listener_rule.dhall).Redirect
  }
