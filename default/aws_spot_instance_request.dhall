...
let awsSpotInstanceRequest =
  ...
  , credit_specification = None (../dhall/aws_spot_instance_request.dhall).CreditSpecification
  , ebs_block_device = None (List (../dhall/aws_spot_instance_request.dhall).EbsBlockDevice)
  , ephemeral_block_device = None (List (../dhall/aws_spot_instance_request.dhall).EphemeralBlockDevice)
  , network_interface = None (List (../dhall/aws_spot_instance_request.dhall).NetworkInterface)
  , root_block_device = None (../dhall/aws_spot_instance_request.dhall).RootBlockDevice
  }
