...
let defaultAction =
  ...
  , authenticate_cognito = None (../dhall/aws_lb_listener.dhall).AuthenticateCognito
  , authenticate_oidc = None (../dhall/aws_lb_listener.dhall).AuthenticateOidc
  , fixed_response = None (../dhall/aws_lb_listener.dhall).FixedResponse
  , redirect = None (../dhall/aws_lb_listener.dhall).Redirect
  }
